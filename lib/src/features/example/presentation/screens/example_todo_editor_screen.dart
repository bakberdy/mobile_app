...
class ExampleTodoEditorScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) => BlocProvider(
    create: (_) =>
        sl<ExampleTodoEditorBloc>()..add(ExampleTodoEditorEvent.started(todo)),
...
class _ExampleTodoEditorScreenContent extends StatelessWidget {
  ...
  ) => BlocConsumer<ExampleTodoEditorBloc, ExampleTodoEditorState>(
          ...
          bottomNavigationBar: SafeArea(
            ...
            child: BaseFilledButton.primary(
              onPressed: canSubmit && !isSubmitDisabled
                  ...
                  : null,
              label: isEditing ? context.l10n.updateTodo : context.l10n.addTodo,
              loading: isLoading,
                      ...
                      _buildInputCard(
                        ...
                        child: TextFormField(
                          ...
                          onChanged: (value) => context
                              .read<ExampleTodoEditorBloc>()
                              .add(ExampleTodoEditorEvent.titleChanged(value)),
                      ...
                      _buildInputCard(
                        ...
                        child: Align(
                          ...
                          child: Switch.adaptive(
                            ...
                            onChanged: (value) => context
                                .read<ExampleTodoEditorBloc>()
                                .add(ExampleTodoEditorEvent.doneChanged(value)),
                          ),
                        ),
                      ),
                    ],
  ...
  Widget _buildGlowBubble(Color color) => IgnorePointer(
    child: DecoratedBox(
      decoration: BoxDecoration(
        shape: BoxShape.circle,
        boxShadow: [BoxShadow(color: color, blurRadius: 120, spreadRadius: 48)],
      ),
